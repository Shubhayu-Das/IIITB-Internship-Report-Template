...
\usepackage{titlesec}
\titleformat{\chapter}[block]{\normalfont\Large\bfseries\centering}{\thechapter.}{14pt}{\MakeUppercase}
\titleformat*{\section}{\normalfont\normalsize\bfseries}
...
\begin{document}
	...
	\precursortitle{Acknowledgement}
	\vspace{1cm}
	...
	%------------------------------------------------------------
	% Tables page
    % Remove this page if it's not required
	%------------------------------------------------------------
	\newpage
    ...
    % Please remove these! This is only there to show the \doublespacing
    \lipsum[100]\\
	...
	Put all your content in chapters from here onwards. Add chapters as per need
	...
	\chapter{Key Takeaways from the Internship}

	Don't remove this chapter, it's actually required.
	...
	This is the last numbered chapter in the report.
    ...
    You can use 'bibtex' styling for this. I am not providing this in the template, because it can be a pain sometimes, but that's one of the easiest ways I know of.
